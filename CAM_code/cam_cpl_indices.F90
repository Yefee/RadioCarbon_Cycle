module cam_cpl_indices
  ...
  integer :: index_a2x_Sa_d14c         ! bottom atm level  c14
  integer :: index_a2x_Sa_co2abio         ! bottom atm level  c14
...
!  integer :: index_x2a_Fall_fc14_lnd   ! c14 flux from land, keep for later use   
  integer :: index_x2a_Faoo_fc14_ocn   ! c14 flux from ocean 
  integer :: index_x2a_Faoo_fco2abio_ocn   ! abiotic co2 flux from ocean 
...
!    index_x2a_Fall_fc14_lnd = mct_avect_indexra(x2a,'Fall_fc14_lnd',perrWith='quiet')
    index_x2a_Faoo_fc14_ocn = mct_avect_indexra(x2a,'Faoo_fc14_ocn',perrWith='quiet')
    index_x2a_Faoo_fco2abio_ocn = mct_avect_indexra(x2a,'Faoo_fco2abio_ocn',perrWith='quiet')
    ...
    index_a2x_Sa_d14c    = mct_avect_indexra(a2x,'Sa_d14c',perrWith='quiet')
    index_a2x_Sa_co2abio    = mct_avect_indexra(a2x,'Sa_co2abio',perrWith='quiet')
    
    write(iulog,*) 'index_a2x_Sa_d14c is', index_a2x_Sa_d14c
    write(iulog,*) 'index_a2x_Sa_co2abio is', index_a2x_Sa_co2abio
