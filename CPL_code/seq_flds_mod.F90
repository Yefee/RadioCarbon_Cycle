...
! !INPUT/OUTPUT PARAMETERS:
     ...
     namelist /seq_cplflds_inparm/  &
          flds_co2a, flds_co2b, flds_co2c, flds_co2_dmsa, flds_wiso, glc_nec, flds_c14c
...
!-------------------------------------------------------------------------------
     ...
     call shr_mpi_bcast(flds_c14c    , mpicom)
     ...
     if (flds_c14c) then
        call seq_flds_add(a2x_states, "Sa_d14c")
        call seq_flds_add(x2o_states, "Sa_d14c")
        longname = 'D14C at the lowest model level'
        stdname  = ''
        units    = 'permil'
        attname  = 'Sa_d14c'
        call metadata_set(attname, longname, stdname, units)
        
        call seq_flds_add(a2x_states, "Sa_co2abio")
        call seq_flds_add(x2o_states, "Sa_co2abio")
        longname = 'Abiotic CO2 at the lowest model level'
        stdname  = ''
        units    = '1e-6 mol/mol'
        attname  = 'Sa_co2abio'
        call metadata_set(attname, longname, stdname, units)
        
        call seq_flds_add(o2x_fluxes, "Faoo_fc14_ocn")
        call seq_flds_add(x2a_fluxes, "Faoo_fc14_ocn")
        longname = 'Surface flux of C14O2 from ocean'
        stdname  = 'surface_upward_flux_of_carbon_dioxide_where_open_sea'
        units    = 'moles m-2 s-1'
        attname  = 'Faoo_fc14_ocn' 
        call metadata_set(attname, longname, stdname, units)
        
        call seq_flds_add(o2x_fluxes, "Faoo_fco2abio_ocn")
        call seq_flds_add(x2a_fluxes, "Faoo_fco2abio_ocn")
        longname = 'Surface flux of abio co2 from ocean'
        stdname  = 'surface_upward_flux_of_carbon_dioxide_where_open_sea'
        units    = 'moles m-2 s-1'
        attname  = 'Faoo_fco2abio_ocn' 
        call metadata_set(attname, longname, stdname, units)     
     endif
