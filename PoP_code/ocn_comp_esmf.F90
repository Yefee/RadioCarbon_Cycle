...
!-----------------------------------------------------------------------
   ...
   if (index_x2o_Sa_d14c > 0) then
      call named_field_register('ATM_D14C', ATM_D14C_nf_ind)
   endif
   if (index_x2o_Sa_co2abio > 0) then
      call named_field_register('ATM_CO2abio', ATM_CO2abio_nf_ind)
   endif
   
   call document('esmf:', 'ATM_D14C', ATM_D14C_nf_ind)
   call document('esmf:', 'ATM_CO2abio', ATM_CO2abio_nf_ind)
