...
! !PUBLIC DATA MEMBERS:
   ...
   integer(kind=int_kind), public :: &
      ...
      ATM_D14C_nf_ind = 0,     & ! bottom atm level d14c
      ATM_CO2abio_nf_ind = 0,  & ! bottom atm level abitotic co2
      CO2abio_F_nf_ind = 0,    & ! abiotic co2 index for ocn_export
      C14_F_nf_ind = 0,        & ! abiotic co2 index for ocn_export
