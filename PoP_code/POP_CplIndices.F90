module POP_CplIndices
  ...
  integer :: index_o2x_Faoo_fc14_ocn  ! 14co2
  integer :: index_o2x_Faoo_fco2abio_ocn  ! abio co2
  ...
  integer :: index_x2o_Sa_d14c         ! bottom atm level d14c
  integer :: index_x2o_Sa_co2abio      ! bottom atm level abiotic co2
...
contains
  ...
  subroutine POP_CplIndicesSet( )
    ...
    index_o2x_Faoo_fc14_ocn = mct_avect_indexra(o2x,'Faoo_fc14_ocn',perrWith='quiet')
    index_o2x_Faoo_fco2abio_ocn = mct_avect_indexra(o2x,'Faoo_fco2abio_ocn',perrWith='quiet')
    ...
    index_x2o_Sa_d14c       = mct_avect_indexra(x2o,'Sa_d14c',perrWith='quiet')
    index_x2o_Sa_co2abio       = mct_avect_indexra(x2o,'Sa_co2abio',perrWith='quiet')
    
!    write(stdout,*) 'index_x2o_Sa_co2diag', index_x2o_Sa_co2diag
!    write(stdout,*) 'index_x2o_Sa_d14c', index_x2o_Sa_d14c  
!    write(stdout,*) 'index_x2o_Sa_co2abio', index_x2o_Sa_co2abio  
